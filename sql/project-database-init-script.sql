...
VALUES 
    ('Exploring Auckland', '2023-10-10', '08:45:00', 'Discover the charm of Auckland and its stunning landmarks.', 'Auckland', 'https://www.youtube.com/watch?v=abc123', 'images/blogs/1/auckland.png', 1),
    ('Adventure in Wellington', '2023-10-05', '12:30:00', 'Experience thrilling adventures in Wellington.', 'Wellington', 'https://www.youtube.com/watch?v=def456', 'images/blogs/2/wellington.png', 2),
    ('Nature Retreat in Queenstown', '2023-10-20', '10:00:00', 'Explore the natural beauty of Queenstown and its surroundings.', 'Queenstown', 'https://www.youtube.com/watch?v=ghi789', 'images/blogs/3/queenstown.png', 1);
