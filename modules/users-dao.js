...
async function retrieveAllBlogs_and_users() {
    ...
    SELECT b.id, title, blog_date, blog_time, article,  img_link, writer_id,username, description,  avatar_link from blog as b, users as u
    WHERE b.writer_id=u.id ORDER by blog_date DESC`);
